            ...
            <div className="sm:w-full py-10 lg:py-0 lg:w-1/2 xl:w-3/5 2xl:w-2/3 h-fit flex flex-col gap-10 sm:text-xl border-teal-600">
              ...
              ></p>
              {
                work.link && (
                  <a
                    href={work.link}
                    className="flex gap-4 duration-100 items-center justify-start w-full md:w-1/2 py-4 px-8 text-xl font-medium rounded-2xl bg-slate-200 group relative hover:scale-95 overflow-hidden"
                    target="_blank"
                  >
                    <div className="relative z-10 min-w-fit">Live Site</div>
                    <div className="relative z-10 w-0 group-hover:w-full h-1 border-b-2 border-[#222] duration-1000 ease-[cubic-bezier(0.76, 0, 0.24, 1)]"></div>
      ...
      <section className="w-full min-h-fit flex items-start justify-center px-5 sm:px-20">
        <div className="container my-10 sm:my-0">
          <div className="w-full h-fit grid gap-5 grid-cols-1 sm:grid-cols-2">
            <div className="col-span-1 sm:col-span-2 aspect-video rounded-lg lg:rounded-3xl bg-slate-200 flex overflow-hidden shadow-2xl">
          ...
          <div className="col-span-1 flex items-center justify-start">
            {previosWork !== undefined ?(
                <Link to={`/projects/${previosWork.name}`}>
                  <div className="min-w-fit py-2 sm:py-4 px-4 sm:px-8 font-medium rounded-2xl bg-slate-200 relative group overflow-hidden hover:scale-95 duration-100">
                    <div className="relative z-10">Previous: <br /><span className="font-bold">{previosWork.name}</span></div>
                    <div className="absolute w-full h-full left-0 top-full rounded-2xl bg-violet-300 group-hover:top-0 origin-left rotate-12 group-hover:rotate-0 ease-[cubic-bezier(0.76, 0, 0.24, 1)] duration-500"></div>
                  </div>
                </Link>
              ) : null }
          </div>
